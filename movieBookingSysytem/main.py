...
if __name__ == "__main__":
    ...
    movieBookingService = MovieBookingService(theaters=[], bookingManager=bookingManager, paymentStrategies=[paymentStrategy, creditCardStrategy], users=[user], screens=[screen], seats=seats, bookings=[])
    movieBookingService.bookSeat(user, screen, seats[0], paymentStrategy)
